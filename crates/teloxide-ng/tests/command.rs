...
// teloxide_ng::utils::command was a failure
...
fn parse_custom_parser() {
    mod parser {
        use teloxide_ng::utils::command::ParseError;
...
fn descriptions_off() {
    ...
    assert_eq!(DefaultCommands::descriptions().to_string(), "/help â€” off".to_owned());
}
...
fn alias() {
    ...
    enum DefaultCommands {
        ...
        #[command(alias = "h")]
        Help,
        #[command(alias = "Ð¿Ñ€Ð¸Ð²ÐµÑ‚_Ð¼Ð¸Ñ€")]
        HelloWorld(String),
    }
    ...
    assert_eq!(
        DefaultCommands::HelloWorld("username".to_owned()),
        DefaultCommands::parse("/Ð¿Ñ€Ð¸Ð²ÐµÑ‚_Ð¼Ð¸Ñ€ username", "").unwrap()
    );
}
...
fn alias_help_message() {
    ...
    assert_eq!(
        "/start â€” Start command\n/help, /h â€” Help command\n/hello_world, /Ð¿Ñ€Ð¸Ð²ÐµÑ‚_Ð¼Ð¸Ñ€",
        DefaultCommands::descriptions().to_string()
    );
}
...
fn aliases() {
    ...
    enum DefaultCommands {
        Start,
        #[command(aliases = ["h", "Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ"])]
        Help,
        #[command(aliases = ["Ð¿Ñ€Ð¸Ð²ÐµÑ‚_Ð¼Ð¸Ñ€"])]
        HelloWorld(String),
    }
    ...
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/help", "").unwrap());
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/h", "").unwrap());
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ", "").unwrap());
    assert_eq!(
        DefaultCommands::HelloWorld("username".to_owned()),
        DefaultCommands::parse("/hello_world username", "").unwrap()
    );
...
fn aliases_help_message() {
    ...
    assert_eq!(
        "/start â€” Start command\n/help, /h, /Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ â€” Help command\n/hello_world, \
         /Ð¿Ñ€Ð¸Ð²ÐµÑ‚_Ð¼Ð¸Ñ€",
        DefaultCommands::descriptions().to_string()
    );
}
...
fn hide_command_with_aliases() {
    ...
    assert_eq!("/help, /h â€” Help.", DefaultCommands::descriptions().to_string());
}
...
fn hide_aliases_with_aliases() {
    ...
    #[command(rename_rule = "snake_case")]
    enum DefaultCommands {
        #[command(aliases = ["s", "ÑÑ‚Ð°Ñ€Ñ‚"])]
        Start,
        #[command(aliases = ["h", "Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ"], hide_aliases)]
        Help,
    }

    assert_eq!(DefaultCommands::Start, DefaultCommands::parse("/start", "").unwrap());
    assert_eq!(DefaultCommands::Start, DefaultCommands::parse("/s", "").unwrap());
    assert_eq!(DefaultCommands::Start, DefaultCommands::parse("/ÑÑ‚Ð°Ñ€Ñ‚", "").unwrap());
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/help", "").unwrap());
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/h", "").unwrap());
    assert_eq!(DefaultCommands::Help, DefaultCommands::parse("/Ð¿Ð¾Ð¼Ð¾Ñ‰ÑŒ", "").unwrap());

    assert_eq!("/start, /s, /ÑÑ‚Ð°Ñ€Ñ‚\n/help", DefaultCommands::descriptions().to_string());
}
