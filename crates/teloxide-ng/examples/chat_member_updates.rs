use teloxide_core_ng::adaptors::DefaultParseMode;
use teloxide_ng::{prelude::*, types::ParseMode, utils::html};
...
///
/// [requester adaptor]: teloxide_ng::requests::Requester#adaptors
type Bot = DefaultParseMode<teloxide_ng::Bot>;
...
async fn main() -> ResponseResult<()> {
    ...
    // `html::user_mention`
    let bot = teloxide_ng::Bot::from_env().parse_mode(ParseMode::Html);
