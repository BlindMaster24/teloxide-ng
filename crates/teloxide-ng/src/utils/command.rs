...
//!
//! [examples/admin]: https://github.com/teloxide/teloxide/blob/master/crates/teloxide-ng/examples/admin.rs
...
use teloxide_core_ng::types::{BotCommand, Me};
#[cfg(feature = "macros")]
pub use teloxide_macros_ng::BotCommands;
...
impl<'a> CommandDescriptions<'a> {
    ...
    /// ]);
    ///
    /// assert_eq!(descriptions.to_string(), "/start â€” start this bot\n/help â€” show this message");
    /// assert_eq!(
    ///     descriptions.username("username_of_the_bot").to_string(),
    ///     "/start@username_of_the_bot â€” start this bot\n/help@username_of_the_bot â€” show this \
    ///      message"
    /// );
    /// ```
    #[must_use]
