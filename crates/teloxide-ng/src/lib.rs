...
//!
//! [[`examples/throw_dice.rs`](https://github.com/teloxide/teloxide/blob/master/crates/teloxide-ng/examples/throw_dice.rs)]
//! ```no_run
...
//! handler function):
//! ```no_run
//! use teloxide_ng::{prelude::*, types::User};
//!
...
#[doc(inline)]
pub use teloxide_core_ng::*;

#[cfg(feature = "macros")]
pub use teloxide_macros_ng as macros;
...
use teloxide_core_ng::requests::ResponseResult;
