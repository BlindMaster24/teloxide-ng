...
//!
//! [`payloads`]: teloxide_core_ng::payloads

use teloxide_core_ng::{payloads::*, types::*};
...
mod tests {
    ...
    use super::*;
    use teloxide_core_ng::{Bot, prelude::*};
    ...
    fn test_reply_to_adaptors() {
        use teloxide_core_ng::{adaptors::trace::Settings, requests::HasPayload};
