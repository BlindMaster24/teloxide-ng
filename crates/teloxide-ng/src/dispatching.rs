...
//! # use teloxide_ng::dispatching::{UpdateHandler, UpdateFilterExt, dialogue, dialogue::InMemStorage};
//! # use teloxide_ng::utils::command::BotCommands;
//! # use teloxide_ng::types::Update;
...
//!     use dptree::case;
//!
//!     let command_handler = teloxide_ng::filter_command::<Command, _>()
//!         .branch(
//!             case![State::Start]
...
//! ```no_run
//! # use teloxide_ng::Bot;
//! # use teloxide_ng::types::{Message, CallbackQuery};
//! # use teloxide_ng::dispatching::dialogue::{InMemStorage, Dialogue};
//! # enum State{}
//! #
...
//! # use teloxide_ng::Bot;
//! # use teloxide_ng::requests::RequesterExt;
//! # use teloxide_ng::dispatching::{Dispatcher, dialogue::InMemStorage};
//! # enum State {}
//! # fn schema() -> teloxide_ng::dispatching::UpdateHandler<Box<dyn std::error::Error + Send + Sync + 'static>> { teloxide_ng::dptree::entry() }
//! #[tokio::main]
//! async fn main() {
...
//! [dialogues]: dialogue
//! [`examples/purchase.rs`]: https://github.com/teloxide/teloxide/blob/master/crates/teloxide-ng/examples/purchase.rs
...
//! [`examples/dispatching_features.rs`]: https://github.com/teloxide/teloxide/blob/master/crates/teloxide-ng/examples/dispatching_features.rs
