...
use teloxide_core_ng::types::AllowedUpdate;
...
impl EventKind for Kind {
    fn full_set() -> HashSet<Self> {
        ...
        //     > receive. For example, specify [â€œmessageâ€,
        //     > â€œedited_channel_postâ€,
        //     > â€œcallback_queryâ€] to only receive updates of these types. See
        //     > Update
...
mod tests {
    #[cfg(feature = "macros")]
    use crate::{
        self as teloxide_ng, // fixup for the `BotCommands` macro
