...
pub struct Options {
    ...
    /// â€œX-Telegram-Bot-Api-Secret-Tokenâ€ in every webhook request,
    /// 1-256 characters. Only characters `A-Z`, `a-z`, `0-9`, `_` and `-`
    /// are allowed. The header is useful to ensure that the request comes
    ...
    R: Requester,
{
    ...
    use teloxide_core_ng::requests::HasPayload;
