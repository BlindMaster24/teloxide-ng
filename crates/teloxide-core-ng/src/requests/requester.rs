...
///
/// ```compile_fail
/// # use teloxide_core_ng::{prelude::*, types::{ChatId, ParseMode}};
/// let bot: Bot = Bot::new("TOKEN").parse_mode(ParseMode::Html);
/// ```
/// ```rust
/// # use teloxide_core_ng::{prelude::*, types::{ChatId, ParseMode}, adaptors::DefaultParseMode};
...
/// # use teloxide_core_ng::{adaptors::{DefaultParseMode, Throttle}, requests::RequesterExt, types::ParseMode};
/// type Bot = DefaultParseMode<Throttle<teloxide_core_ng::Bot>>;
///
/// let bot: Bot = teloxide_core_ng::Bot::new("TOKEN")
///     .throttle(<_>::default())
///     .parse_mode(ParseMode::Html);
/// # let _ = bot;
/// # };
