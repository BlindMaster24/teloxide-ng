...
///
/// ```rust
/// use teloxide_core_ng::types::{File, FileId, FileUniqueId};
/// #
/// # let get_file = || File { meta: teloxide_core_ng::types::FileMeta { id: FileId(String::new()), unique_id: FileUniqueId(String::new()), size: 0 }, path: String::new() };
